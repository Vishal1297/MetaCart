...
<body>
	...
	<div id="main">
		...
		%>
		<form id="form" action="addCategory.do" method="post">
			<table>
				<tr><td>Category ID :</td></tr>
				<tr><td><input type="number" placeholder="Enter Category ID" name="categoryId"></td></tr>
				<tr><td>Category Name :</td></tr>
				<tr><td><input type="text" placeholder="Enter Category Name" name="categoryName"></td></tr>
